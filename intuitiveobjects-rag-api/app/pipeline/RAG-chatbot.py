...
def miner_get_pdf_text(pdf_path):
    text = miner_extract_text(pdf_path)
    return text
...
def get_vector_store(text_chunks):
    ...
    if (text_chunks):
        ...
        st.success("Unable to chunk the PDF properly\n")
        print("Unable to chunk the PDF properly\n")
    ...
    with st.sidebar:
        ...
        if st.button("Submit & Process"):
            with st.spinner("Processing..."):
                ...
                raw_text = miner_get_pdf_text(pdf_docs)
