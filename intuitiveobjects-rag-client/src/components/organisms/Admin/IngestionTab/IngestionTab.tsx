...
export const IngestionTab = () => {
  ...
  const handleDeleteFile = async (fileId: string) => {
    confirmAction(
      "Are you sure?",
      "This file will be permanently deleted. You won't be able to revert this!",
      "Yes, delete file!"
  ...
  const columns = [
    {
      ...
      render: (value: string) => (
        <div className="flex items-center gap-x-3">
          ...
          <div className="text-sm font-medium text-gray-400 truncate max-w-[150px] sm:max-w-xs">
            {value}
          </div>
        </div>
      ),
...
// },
  ...
  return (
    <>
      <h1 className="text-2xl text-gray-200 font-semibold mb-6">
        Document Ingestion
      </h1>
